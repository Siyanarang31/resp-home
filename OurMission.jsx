            ...
            <div className = 'ourm-card'>
                ...
                <div className = 'ourm-grid'>
                    <div className = 'ourm-video'>
                        <Zoom><iframe className= 'respon-video' src="https://www.youtube.com/embed/0ZmyuVIDbk4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></Zoom>
                    </div>
